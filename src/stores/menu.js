...
export const fallbackAdminMenus = [
  ...
  { id: 8, path: '/admin/exam-configs', name: 'ExamConfigManage', component: '@/views/admin/ExamConfigManage.vue', meta: { title: '考试配置', icon: 'Tickets', requiresAuth: true, requiresAdmin: true } },
